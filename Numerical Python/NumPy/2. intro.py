...
Why Use NumPy?
In python se have lists that serve the purpose of arrays, but they are slow to process.
NumPy aims to provide an array object that is up to 50x faster than triditionas Python lists.
